...
export CROSS_ROOT="/opt/gcc-arm-9.2-2019.12-x86_64-aarch64-none-linux-gnu"
export COMPILER_PREFIX="aarch64-none-linux-gnu-"
export PATH=$CROSS_ROOT/bin:/snap/bin:/bin:/usr/bin:/usr/local/bin
export SYSROOT="/opt/gcc-arm-9.2-2019.12-x86_64-aarch64-none-linux-gnu/aarch64-none-linux-gnu/libc/"

export PATH="/opt/cuda-11.4/bin:$PATH"
export CUDA_COMPILER=/opt/cuda-11.4/bin/nvcc
export LD_LIBRARY_PATH="/opt/cuda-11.4/targets/aarch64-linux/lib"

export BUILD_CONFIG=Release
export CPU_ARCHITECTURE=aarch64

export  onnxruntime_CUDNN_HOME=/opt/aarch64/cudnn-aarch64-8.6-11/usr
export  onnxruntime_CUDA_HOME=/opt/cuda-11.4/targets/aarch64-linux
...
--cmake_extra_defines \
  ...
  CUDA_HOME=/opt/aarch64/cuda-11.4 \
...
rm -rf AARCH64_CUDA_11 || true
mkdir AARCH64_CUDA_11  || true


cp -rf ./onnxruntime-1.16.3/include ./AARCH64_CUDA_11 || true
RELEASE="./onnxruntime-1.16.3/build/Linux/Release"
cp $RELEASE/*.a ./AARCH64_CUDA_11 2>>/dev/null || true
cp $RELEASE/*.so ./AARCH64_CUDA_11 2>>/dev/null || true
shopt -s globstar || true
cp -rf $RELEASE/_deps/*-build/**/*.a ./AARCH64_CUDA_11 2>>/dev/null || true
cp -rf $RELEASE/_deps/*-build/**/*.so ./AARCH64_CUDA_11 2>>/dev/null || true
