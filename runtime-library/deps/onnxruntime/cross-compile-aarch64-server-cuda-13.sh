...
rm -rf AARCH64_SERVER_CUDA_13 || true
mkdir AARCH64_SERVER_CUDA_13  || true

cp -rf ./onnxruntime-bbd0a80/include ./AARCH64_SERVER_CUDA_13 || true
RELEASE="./onnxruntime-bbd0a80/build/Linux/Release"
cp $RELEASE/*.a ./AARCH64_SERVER_CUDA_13 2>>/dev/null || true
cp $RELEASE/*.so ./AARCH64_SERVER_CUDA_13 2>>/dev/null || true
shopt -s globstar || true
cp -rf $RELEASE/_deps/*-build/**/*.a ./AARCH64_SERVER_CUDA_13 2>>/dev/null || true
cp -rf $RELEASE/_deps/*-build/**/*.so ./AARCH64_SERVER_CUDA_13 2>>/dev/null || true
