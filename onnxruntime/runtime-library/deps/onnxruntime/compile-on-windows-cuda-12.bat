...
set "CUDA_PATH=C:\CUDA\v12.8"
set "CUDNN_PATH=C:\cuDNN\cudnn-windows-x86_64-9.10.1.4_cuda12-archive"
...
if exist X86_64_WINDOWS_CUDA_12 rmdir /s /q X86_64_WINDOWS_CUDA_12
mkdir X86_64_WINDOWS_CUDA_12
mkdir X86_64_WINDOWS_CUDA_12\include
...
@echo off
for /R %%f in (*.lib) do (
    REM Copy file to X86_64_WINDOWS_CUDA_12
    copy "%%f" "..\..\..\..\X86_64_WINDOWS_CUDA_12\"
)
for /R %%f in (*.dll) do (
    REM Copy file to X86_64_WINDOWS_CUDA_12
    copy "%%f" "..\..\..\..\X86_64_WINDOWS_CUDA_12\"
...
xcopy .\include\onnxruntime ..\X86_64_WINDOWS_CUDA_12\include\onnxruntime /E /I