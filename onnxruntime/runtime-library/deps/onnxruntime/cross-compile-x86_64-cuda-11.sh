...
export LD_LIBRARY_PATH="/opt/cuda-11.8/targets/x86_64-linux/lib:/opt/cuda-11.8/lib:"
export CUDA_INSTALL_PATH="/opt/cuda-11.8"

export NVCC_LD_LIBRARY_PATH="/opt/cuda-11.8/targets/x86_64-linux/lib,/opt/cuda-11.8/lib,/opt/x86_64-unknown-linux-gnu-gcc-9.5.0/x86_64-unknown-linux-gnu/sysroot/lib,/opt/x86_64-unknown-linux-gnu-gcc-9.5.0/x86_64-unknown-linux-gnu/sysroot/lib64"
export LD_LIBRARY_PATH_EXT="/opt/cuda-11.8/targets/x86_64-linux/lib;/opt/cuda-11.8/lib;/opt/x86_64-unknown-linux-gnu-gcc-9.5.0/x86_64-unknown-linux-gnu/sysroot/lib;/opt/x86_64-unknown-linux-gnu-gcc-9.5.0/x86_64-unknown-linux-gnu/sysroot/lib64"

export  onnxruntime_CUDNN_HOME=/opt/cudnn-linux-x86_64-8.9.5.29_cuda11-archive
export  onnxruntime_CUDA_HOME=/opt/cuda-11.8/targets/x86_64-linux

export CUDA_ARCHITECTURES="52;60;61;70;75;80;86;87;89"
...
--cmake_extra_defines \
  ...
  CMAKE_CUDA_COMPILER=/opt/cuda-11.8/bin/nvcc \
...
rm -rf X86_64_CUDA_11 || true
mkdir X86_64_CUDA_11  || true

cp -rf ./$ort_foldername/include ./X86_64_CUDA_11  || true
RELEASE="./$ort_foldername/build/Linux/Release"
cp $RELEASE/*.a ./X86_64_CUDA_11 2>>/dev/null  || true
cp $RELEASE/*.so ./X86_64_CUDA_11 2>>/dev/null  || true
shopt -s globstar
cp -rf $RELEASE/_deps/*-build/**/*.a ./X86_64_CUDA_11 2>>/dev/null  || true
cp -rf $RELEASE/_deps/*-build/**/*.so ./X86_64_CUDA_11 2>>/dev/null  || true
